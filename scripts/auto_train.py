...
def train_model(api: sly.Api) -> Path:
    train_app_name = "supervisely-ecosystem/train-mmdetection-v3"
    ...
    # @TODO: add experiment name to team files folder path
    team_files_folder = Path("/mmdetection-3-auto") / TASK_TYPE / project_name / str(task_id)
